...
form_all.graph_purchase_button.clicked.connect(on_click_graph_purch)
...
form_tool.delete_income_button.clicked.connect(delete_useless_income)
form_tool.delete_item_button.clicked.connect(delete_useless_item)
form_tool.delete_card_button.clicked.connect(delete_useless_card)
